    ...
    def setup_routes(self):
        ...
        def cancel_operation(agv_id):
            ...
            try:
                ...
                self.agv_states[agv_id]['last_operation_status'] = "Operation cancelled"
                self.agv_states[agv_id]['last_operation_result'] = "cancelled"
                self.agv_states[agv_id]['current_goal_handle'] = None
                
                # Release dock reservation if it was reserved for this AGV
                for dock_num, reserved_agv in self.dock_reservations.items():
                    if reserved_agv == agv_id and not self.agv_states[agv_id]['is_docked']:
